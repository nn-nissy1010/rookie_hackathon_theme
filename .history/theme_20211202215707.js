...
for(let count = 0; count<10count++){
    content =`<section class="set">
        ...
        <div class="set_button">
            <button id="back_${count}" class="back_button" onclick="back()">戻る</button>
            <button id="next_${count}" class="next_button" onclick="next()">次へ</button>
        </div>
    </section>`
